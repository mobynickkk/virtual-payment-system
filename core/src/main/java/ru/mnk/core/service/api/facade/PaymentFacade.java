...
public interface PaymentFacade extends PaymentConsumerService {

    default void processPayment(BigDecimal amount, String currencyCode, Long senderId, Long receiverId) {
        transferMoney(amount, currencyCode, senderId, receiverId);
    }
